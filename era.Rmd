...
first, read in the data prep in the other .Rmd:
```{r data_prep, message=FALSE, error=FALSE, warning=FALSE}
...
ok so _definitely_ a gamma distribution.  [this](https://stats.stackexchange.com/questions/72381/gamma-vs-lognormal-distributions) SO answer 
